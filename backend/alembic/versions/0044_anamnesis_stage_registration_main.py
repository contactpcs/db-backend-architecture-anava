...
def downgrade() -> None:
    ...
    op.execute("UPDATE core.\"anamnesis_assessments\" SET \"assessment_stage\" = 'general_registration' WHERE \"assessment_stage\" = 'registration'")
    op.execute("UPDATE core.\"anamnesis_assessments\" SET \"assessment_stage\" = 'main_clinical' WHERE \"assessment_stage\" = 'main'")
